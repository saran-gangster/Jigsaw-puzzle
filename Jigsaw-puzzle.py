...
def ShowEndInterface(screen, width, height):
	...
	title = font.render('Congratulations! You successfully completed the puzzle!', True, (233, 150, 122))
	rect = title.get_rect()
...
def ShowStartInterface(screen, width, height):
	screen.fill(cfg.BACKGROUNDCOLOR)
	tfont = pygame.font.Font(cfg.FONTPATH, width//12)
...
def main():
	...
	pygame.display.set_caption('Jigsaw puzzle-Saran')
